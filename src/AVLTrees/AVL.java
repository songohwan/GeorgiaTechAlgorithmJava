...
//    how do I go about setting the height for each Node / Trees
    public void updateHeightAndBF(AVLNode<T> currentNode) {
        ...
        if (currentNode.getData() == null){
            ...
            int left = currentNode.getLeft().getHeight();
            int right = currentNode.getRight().getHeight();
            currentNode.setHeight(1 + Math.max(right, left));
        }
        ...
        if (currentNode.getData() == null) {
            ...
            int bf = currentNode.getLeft().getHeight() - currentNode.getRight().getHeight();
            currentNode.setBalanceFactor(bf);
        }

//        AVLNode<T> maxHeight = currentNode.setHeight(newHegiht);

    }
// Method to update the nodes BF / Height
